...
Model.prototype.toJSON = function (attributes, externals) {
  var gatherAttributes = function (model) {
    var data = {};
    Utils._.each(attributes || model.attributes, function (attribute) {
      data[attribute] = model[attribute];
    });
    Utils._.each(externals || Utils._.keys(model), function (external) {
      if (model[external] instanceof Model) {
