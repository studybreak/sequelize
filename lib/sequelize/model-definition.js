...
ModelDefinition.prototype.findAll = function(options) {
  ...
  return this.query(QueryGenerator.selectQuery(this.tableName, options), this, {fillPlan: options.fillPlan})
}
...
ModelDefinition.prototype.buildFillPlan = function(options)
{
    ...
    if (options.attributes) {
        options.attribute.forEach(function(attr) {
